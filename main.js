...
function gotresults(error, results) {
    if (error) {
        ...
        if (results[0].label == "cat") {
            document.getElementById("picofan").src = "cat.jfif";
            console.log(cat);
        } else if (results[0].label == "cow") {
            document.getElementById("picofan").src = "cow.webp";
            console.log(cow);
        } else if (results[0].label == "dog") {
            document.getElementById("picofan").src = "dog.jpg";
            console.log(dog);
        } else if (results[0].label == "sheep") {
            document.getElementById("picofan").src = "sheep.avif";
            console.log(sheep);
        }
    }
}